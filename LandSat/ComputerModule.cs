...
namespace LandSat
{
    public class ComputerModule : IComparable<ComputerModule>
    {
        ...
        public ComputerModule(LandSatCore core)
        {
            this.core = core;
            part = core.part;
        ...
        public virtual void OnLoad(ConfigNode local, ConfigNode type, ConfigNode global)
        {
            ...
            {
                Debug.Log("LandSat caught exception in OnLoad for " + this.GetType().Name + ": " + e);
            }
        }
        ...
        public virtual void OnSave(ConfigNode local, ConfigNode type, ConfigNode global)
        {
            ...
            {
                Debug.Log("LandSat caught exception in OnSave for " + this.GetType().Name + ": " + e);
            }
        }
