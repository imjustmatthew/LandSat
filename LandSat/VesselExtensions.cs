...
namespace LandSat
{
    public static class VesselExtensions
    {
        ...
        public static LandSatCore GetMasterLandSat(this Vessel vessel)
        {
            return vessel.GetModules<LandSatCore>().Max();
        }
        ...
        public static ManeuverNode PlaceManeuverNode(this Vessel vessel, Orbit patch, Vector3d dV, double UT)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                {
                    throw new Exception("LandSat VesselExtensions.PlaceManeuverNode: bad dV: " + dV);
                }
            }
